                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">Haber Düzenle</h4>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input value="{{$haberim->title}}" name="title"
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input value="{{$haberim->title_2}}" name="title_2"
                                                                           type="text" class="form-control"
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                @if($haberim->image != '')
                                                                                   <br>
                                                                                    <div class="input-group">
                                                                                        <img
                                                                                            src="{{asset('public/img/'.$haberim->image)}}"
                                                                                            class="form-control">
                                                                                    </div>
                                                                                @endif
                                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea name="text"
                                                                              class="tinymce">{{$haberim->text}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
