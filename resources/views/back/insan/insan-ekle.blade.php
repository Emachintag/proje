                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">İş İlanı Ekle</h4>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input name="title_2" type="text" class="form-control" placeholder="Açıklama" aria-describedby="basic-addon3">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                <label>Kapak Görsel (Tek Fotoğraf)</label>
                                                                <div class="input-group">
