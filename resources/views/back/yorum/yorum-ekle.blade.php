                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">Yorum Ekle</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                <label>Yorum Fotoğraf (Tek Fotoğraf)</label>
                                                                <div class="input-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                <label>Yorum</label>
                                                                <div class="input-group">
                                                                    <input name="text" type="text" class="form-control" placeholder="yorum" aria-describedby="basic-addon3">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
