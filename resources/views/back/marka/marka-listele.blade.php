...
@section('content')
    ...
    if (isset($_GET['id']) AND isset($_GET['sil'])) {
        $id = $_GET['id'];
        // tekli görsel silme
        $kapakFoto = DB::table('marka')->where('id', $id)->first()->image;
        $kapakFoto = public_path("img/" . $kapakFoto);
        if (File::exists($kapakFoto)) {
            File::delete($kapakFoto);
        }
        DB::table('marka')->where('id', $id)->delete();
                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="media align-items-stretch bg-warning text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Marka Sayısı</h4>
                                            <span>Eklenen Marka Sayısı</span>
                                        </div>
                                        <div class="media-right p-2 media-middle">
                                            <h1 class="text-white">{{DB::table('marka')->count()}}</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('marka_ekle')}}'" class="card-content">
                                    <div class="media align-items-stretch bg-info text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Yeni Marka Ekle</h4>
                                            <span>Yeni Marka İçin Tıklayınız</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Marka Listeleme</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                            @foreach(DB::table('marka')->get() as $u)
                                                <tr>
                                                    <td>{{$u->title}}</td>
                                                    <td>{{$u->link}}</td>
                                                    ...
                                                    <td style="text-align: center">
                                                        ...
                                                        <a href="{{route('marka_duzenle', ['id'=>$u->id])}}"
