...
@section('content')
    <?php
    if (isset($_GET['id'])) {
        $ekip = DB::table('sorular')->where('id', $_GET['id'])->first();
    } else {
        header("Location:" . route('soru'));
    }
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">Sık Sık Sorulan Sorular Düzenle</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form-horizontal" method="post" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="la la-newspaper-o"></i>Sık Sık Sorulan Sorular</h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="card-body">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea name="text"
                                                                              class="tinymce">{{$ekip->text}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
