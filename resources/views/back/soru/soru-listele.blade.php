...
@section('content')
    ...
    if (isset($_GET['id']) AND isset($_GET['sil'])) {
        $id = $_GET['id'];
        DB::table('sorular')->where('id', $id)->delete();
                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="media align-items-stretch bg-warning text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Sık Sık Sorulan Sorular Sayısı</h4>
                                            <span>Eklenen Sık Sık Sorulan Sorular Sayısı</span>
                                        </div>
                                        <div class="media-right p-2 media-middle">
                                            <h1 class="text-white">{{DB::table('sorular')->count()}}</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('soru_ekle')}}'" class="card-content">
                                    <div class="media align-items-stretch bg-info text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Yeni Sık Sık Sorulan Sorular Ekle</h4>
                                            <span>Yeni Sık Sık Sorulan Sorular İçin Tıklayınız</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Sık Sık Sorulan Sorular Listeleme</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                            @foreach(DB::table('sorular')->get() as $u)
                                                <tr>
                                                    <td>{{$u->title}}</td>
                                                    <td>{{$u->text}}</td>
                                                    <td style="text-align: center">
                                                        ...
                                                        <script>
                                                            $(document).ready(function(){
                                                                $('#delete-confir{{$u->id}}').on('click',function(){
                                                                    swal({
                                                                        title: "Sık Sık Sorulan Sorular Silme",
                                                        ...
                                                        <a href="{{route('soru_duzenle', ['id'=>$u->id])}}"
