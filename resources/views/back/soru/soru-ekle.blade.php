                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">Sık Sık Sorulan Sorular Ekle</h4>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input name="title" type="text" class="form-control" placeholder="Soru" aria-describedby="basic-addon3">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
