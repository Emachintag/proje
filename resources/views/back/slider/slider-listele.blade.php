                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="media align-items-stretch bg-warning text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Slider Sayısı</h4>
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('slider_ekle')}}'" class="card-content">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Slider Listeleme</h4>
