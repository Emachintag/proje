...
@section('content')
    ...
    if (isset($_GET['id']) AND isset($_GET['sil'])) {
        $id = $_GET['id'];
        // tekli görsel silme
        $kapakFoto = DB::table('galeri')->where('id', $id)->first()->image;
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('galeri_ekle')}}'" class="card-content">
                                    <div class="media align-items-stretch bg-info text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Yeni Galeri Ekle</h4>
                                            <span>Yeni Galeri İçin Tıklayınız</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Galeri Listeleme</h4>
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <a href="{{route('galeri_duzenle', ['id'=>$u->id])}}"
