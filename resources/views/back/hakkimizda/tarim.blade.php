...
@section('content')
    <?php
    $hakkimizda = DB::table('tarim')->first();
    ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">Tarım Makinaları Ekle</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form-horizontal" method="post" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="la la-newspaper-o"></i>Tarım Makinaları</h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                <label>Tarım Makinaları Başlığı</label>
                                                ...
                                                <div class="col-md-12">
                                                    <label>Tarım Makinaları Görsel (Tek
                                                        Fotoğraf)</label>
                                                    <div class="input-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                <label>Tarım Makinaları Metni</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                <label>Tarım Makinaları Metni (Anasayfa icin)</label>
                                                                <div class="form-group">
