...
@section('content')
    ...
    if (isset($_GET['id']) AND isset($_GET['sil'])) {
        ...
        // çoklu pdf silme
        foreach (DB::table('blog_belge')->where('Blog_id', $id)->get() as $u) {
        ...
        DB::table('blog_gorsel')->where('blog_id', $id)->delete();
        DB::table('blog_belge')->where('blog_id', $id)->delete();
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('blog_ekle')}}'"
                                     class="card-content">
                                            ...
                                            @foreach(DB::table('blog')->get() as $u)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        ...
                                                        <a href="{{route('blog_duzenle', ['id'=>$u->id])}}"
