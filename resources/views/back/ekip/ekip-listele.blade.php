                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="media align-items-stretch bg-warning text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Ekip Sayısı</h4>
                                            <span>Eklenen Ekip Sayısı</span>
                                        </div>
                                        <div class="media-right p-2 media-middle">
                                            <h1 class="text-white">{{DB::table('ekip')->count()}}</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('ekip_ekle')}}'" class="card-content">
                                    <div class="media align-items-stretch bg-info text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Yeni Ekip Ekle</h4>
                                            <span>Yeni Ekip İçin Tıklayınız</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Ekip Listeleme</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                            @foreach(DB::table('ekip')->get() as $u)
                                            <tr>
                                                <td>{{$u->isim}}</td>
                                                <td>{{$u->unvan}}</td>
                                                <td>{{$u->email}}</td>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <a href="{{route('ekip_duzenle', ['id'=>$u->id])}}"
