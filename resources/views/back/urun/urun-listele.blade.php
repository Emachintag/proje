...
@section('content')
    ...
    if (isset($_GET['id']) AND isset($_GET['sil'])) {
        ...
        // çoklu pdf silme
        foreach (DB::table('urun_belge')->where('urun_id', $id)->get() as $u) {
        ...
        DB::table('urun_gorsel')->where('urun_id', $id)->delete();
        DB::table('urun_belge')->where('urun_id', $id)->delete();
                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="media align-items-stretch bg-gradient-x-warning text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            ...
                                            <span>Yazdığınız urun Sayısı</span>
                                        </div>
                                        <div class="media-right p-2 media-middle">
                                            <h1 class="text-white">{{DB::table('urun')->count()}}</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('urun_ekle')}}'"
                                     class="card-content">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                            @foreach(DB::table('urun')->get() as $u)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        ...
                                                        <a href="{{route('urun_duzenle', ['id'=>$u->id])}}"
