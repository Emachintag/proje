                                ...
                                <div class="card-content">
                                    <div class="media align-items-stretch bg-warning text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            ...
                                            <span>Kaydedilen Hizmet Kategori Sayısı</span>
                                        </div>
                                ...
                                <div style="cursor: pointer" onclick="location.href='{{route('hizmet_kategori_ekle')}}'" class="card-content">
                                    <div  class="media align-items-stretch bg-info text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            ...
                                            <span>Yeni Hizmet Kategori Eklemek İçin Tıklayınız</span>
                                        </div>
                                        <div class="media-right p-2 media-middle">
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tr>
                                                ...
                                                Sil
                                                    ...
                                                    <a href="/Hizmet-duzenle/" class="btn btn-info btn-min-width btn-glow">
