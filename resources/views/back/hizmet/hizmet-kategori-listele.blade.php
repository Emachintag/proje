...
if (isset($_GET['id']) AND isset($_GET['sil'])) {
    $id = $_GET['id'];
    DB::table('hizmet_kategori')->where('id', $id)->delete();
                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="media align-items-stretch bg-gradient-x-warning text-white rounded">
                                        ...
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Hizmet Kategori Sayısı</h4>
                                            <span>Yazdığınız Hizmet Kategori Sayısı</span>
                                        </div>
                                        <div class="media-right p-2 media-middle">
                                            <h1 class="text-white">{{DB::table('hizmet_kategori')->count()}}</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-md-12">
                            <div class="card overflow-hidden">
                                <div style="cursor: pointer" onclick="location.href='{{route('hizmet_kategori_ekle')}}'" class="card-content">
                                    <div class="media align-items-stretch bg-gradient-x-info text-white rounded">
                                        <div class="p-2 media-middle">
                                            <i class="icon-pencil font-large-2 text-white"></i>
                                        </div>
                                        <div class="media-body p-2">
                                            <h4 class="text-white">Yeni Hizmet Kategori Ekle</h4>
                                            <span>Yeni Hizmet Kategori İçin Tıklayınız</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            <thead>
                                            <tr>
                                                <th>Hizmet Kategori Başlık</th>
                                                <th>Hizmet Kategori Sırası</th>
                                                <th>İşlem</th>

                                            </tr>
                                            </thead>
                                            <tbody>
                                            @foreach(DB::table('hizmet_kategori')->get() as $u)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        ...
                                                        <a href="{{route('hizmet_kategori_duzenle', ['id'=>$u->id])}}"
