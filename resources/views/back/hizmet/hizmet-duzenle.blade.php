...
if(isset($_GET['gorselSil']) && isset($_GET['gorsel']) && isset($_GET['id'])) {
    $sil = $_GET['gorsel'];
    $gorsel = DB::table('hizmet_gorsel')->where('id', $sil)->first()->gorsel;
    $gorsel = public_path("img/".$gorsel);
    if(File::exists($gorsel)) {
        File::delete($gorsel);
    }
    DB::table('hizmet_gorsel')->where('id', $sil)->delete();
    header("Location: ?id=" . $_GET['id']);
    die();
}
if(isset($_GET['belgeSil']) && isset($_GET['belge']) && isset($_GET['id'])) {
    $sil = $_GET['belge'];
    $belge = DB::table('hizmet_belge')->where('id', $sil)->first()->belge;
    $belge = public_path("img/".$belge);
    if(File::exists($belge)) {
        File::delete($belge);
    }
    DB::table('hizmet_belge')->where('id', $sil)->delete();
    header("Location: ?id=" . $_GET['id']);
    die();
}
...
@section('content')
    <?php
    if (isset($_GET['id'])) {
        $hizmetim = DB::table('hizmet')->where('id', $_GET['id'])->first();
    } else {
        header("Location:" . route('hizmet'));
    }
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">Hizmet Düzenle</h4>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input value="{{$hizmetim->title}}" name="title"
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input value="{{$hizmetim->title_2}}" name="title_2"
                                                                           type="text" class="form-control"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                @if($hizmetim->image != '')
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <img
                                                                                            src="{{asset('public/img/'.$hizmetim->image)}}"
                                                                                            class="form-control">
                                                                                    </div>
                                                                                @endif
                                                                            </div>
                                                                            <div class="col-sm-4 col-md-4">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    multiple
                                                                                >
                                                                                @if(DB::table('hizmet_gorsel')->where('hizmet_id', $hizmetim->id)->get())
                                                                                    @foreach(DB::table('hizmet_gorsel')->where('hizmet_id', $hizmetim->id)->get() as $uuuu)
                                                                                        <div class="row mt-1">
                                                                                            <div class="col-8">
                                                                                                <img
                                                                                                    class="form-control"
                                                                                            ...
                                                                                            <div class="col-4 mt-3">
                                                                                                <button type="button"
                                                                                                        onclick="location.href='?gorselSil&gorsel={{$uuuu->id}}&id={{$hizmetim->id}}'"
                                                                            ...
                                                                            <div class="col-sm-4 col-md-4">
                                                                                ...
                                                                                @if(DB::table('hizmet_belge')->where('hizmet_id', $hizmetim->id)->get())
                                                                                    @foreach(DB::table('hizmet_belge')->where('hizmet_id', $hizmetim->id)->get() as $uu)
                                                                                        <span class="text-info mt-1"
                                                                                              style="display: block;"><a target="_blank" href="/public/img/{{$uu->belge}}"><label>{{$uu->belge}}</label><img style="width: 30%" src="{{ asset('/public/back/icon/pdf.png') }}"></a><button type="button" onclick="location.href='?belgeSil&belge={{$uu->id}}&id={{$hizmetim->id}}'" class="btn btn-outline-danger ml-1"><i class="ft ft-minus"></i> Sil</button></span><br>
                                                                                    @endforeach
                                                                                @else
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea name="text"
                                                                              class="tinymce">{{$hizmetim->text}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
