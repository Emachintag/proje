...
@section('content')
    <?php
    if (isset($_GET['id'])) {
        $kategori = DB::table('hizmet_kategori')->where('id', $_GET['id'])->first();
    } else {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="row-separator-colored-controls">Hizmet Kategorisi Ekle</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form-horizontal" method="post" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="la la-newspaper-o"></i>Kategori</h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input value="{{$kategori->kategori}}" name="kategori" type="text" class="form-control" placeholder="Kategori Başlık" aria-describedby="basic-addon3">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="input-group">
                                                                    <input value="{{$kategori->sira}}" name="sira" type="text" class="form-control" placeholder="Kategori Sırası" aria-describedby="basic-addon3">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
